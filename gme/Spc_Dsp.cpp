...
void Spc_Dsp::run( long count, short* out_buf )
{
	...
	while ( --count >= 0 )
	{
		...
		for ( int vidx = 0; vidx < voice_count; vidx++ )
		{
			...
			const BOOST::int16_t* table  = (BOOST::int16_t*) ((char*) ( p_gauss [0] ) + index);
			const BOOST::int16_t* table2 = (BOOST::int16_t*) ((char*) ( p_gauss [1] ) - index);
...
// Interleved cubic table (to improve cache coherency).
// cubic [i * 2 + 0] = -(  i*i*i >> 14) + (  i*i >> 5) - (i << 2);
// cubic [i * 2 + 1] =  (3*i*i*i >> 14) - (5*i*i >> 6)            + (1 << 11);
const BOOST::int16_t Spc_Dsp::cubic [514] =
{
   0,2048,  -4,2048,  -8,2048, -12,2048, -16,2047, -20,2047, -23,2046, -27,2045,
 -30,2043, -34,2042, -37,2041, -41,2039, -44,2037, -47,2035, -50,2033, -53,2031,
 -56,2028, -59,2026, -62,2024, -65,2021, -68,2018, -71,2015, -73,2012, -76,2009,
 -78,2005, -81,2002, -84,1999, -87,1995, -89,1991, -91,1987, -93,1982, -95,1978,
 -98,1974,-100,1969,-102,1965,-104,1960,-106,1955,-109,1951,-110,1946,-112,1940,
-113,1934,-116,1929,-117,1924,-119,1918,-121,1912,-122,1906,-123,1900,-125,1895,
-126,1888,-128,1882,-129,1875,-131,1869,-132,1862,-134,1856,-134,1849,-136,1842,
-136,1835,-138,1828,-138,1821,-140,1814,-141,1806,-141,1799,-142,1791,-143,1783,
-144,1776,-144,1768,-145,1760,-146,1753,-147,1744,-148,1737,-147,1728,-148,1720,
-148,1711,-149,1703,-149,1695,-150,1686,-150,1677,-150,1668,-150,1659,-151,1651,
-151,1641,-151,1633,-151,1623,-151,1614,-152,1605,-152,1596,-151,1587,-152,1577,
-151,1567,-152,1559,-151,1549,-151,1539,-151,1529,-151,1520,-150,1510,-150,1499,
-150,1490,-149,1480,-149,1470,-149,1460,-149,1450,-148,1440,-147,1430,-147,1420,
-146,1408,-146,1398,-145,1389,-145,1378,-144,1367,-144,1357,-143,1346,-142,1336,
-141,1325,-141,1315,-140,1304,-139,1293,-139,1282,-138,1272,-137,1261,-136,1250,
-135,1239,-135,1229,-133,1218,-133,1207,-132,1196,-131,1185,-130,1174,-129,1163,
-128,1152,-127,1141,-126,1130,-125,1119,-124,1108,-123,1097,-121,1086,-121,1075,
-119,1063,-118,1052,-117,1042,-116,1030,-115,1019,-114,1008,-112, 997,-111, 986,
-110, 974,-109, 964,-107, 952,-106, 941,-105, 930,-104, 919,-102, 908,-102, 897,
-100, 886, -99, 875, -97, 864, -97, 853, -95, 842, -94, 831, -92, 820, -91, 809,
 -90, 798, -88, 787, -87, 776, -86, 765, -85, 754, -84, 744, -82, 733, -81, 722,
 -79, 711, -78, 700, -76, 690, -76, 679, -74, 668, -73, 658, -71, 647, -70, 637,
 -68, 626, -67, 616, -66, 605, -65, 595, -63, 584, -62, 574, -60, 564, -60, 554,
 -58, 543, -57, 534, -55, 524, -55, 514, -53, 503, -52, 494, -50, 483, -49, 473,
 -48, 464, -46, 454, -45, 444, -44, 435, -43, 425, -42, 416, -40, 407, -39, 397,
 -38, 387, -37, 378, -36, 370, -35, 360, -34, 351, -32, 342, -31, 333, -30, 325,
 -29, 315, -28, 307, -27, 298, -26, 290, -25, 281, -24, 273, -23, 265, -22, 256,
 -21, 248, -20, 241, -19, 233, -19, 225, -17, 216, -16, 209, -15, 201, -14, 193,
 -14, 186, -13, 178, -12, 171, -11, 164, -11, 157, -10, 150,  -9, 143,  -9, 137,
  -8, 129,  -8, 123,  -7, 117,  -7, 110,  -6, 103,  -5,  97,  -4,  91,  -4,  85,
  -3,  79,  -3,  74,  -3,  68,  -2,  62,  -2,  56,  -2,  51,  -1,  46,  -1,  41,
   0,  35,  -1,  31,   0,  27,  -1,  22,   0,  17,   0,  13,   0,   8,   0,   4,
   0,   0
};

void Spc_Dsp::set_cubic_interpolation( bool enable )
{
	if ( enable )
	{
		p_gauss [0] = &cubic [0];
