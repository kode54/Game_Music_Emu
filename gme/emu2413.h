...
/* Create Object */
EMU2413_API OPLL *VRC7_new(e_uint32 clk) ;
EMU2413_API void VRC7_delete(OPLL *) ;

/* Setup */
EMU2413_API void VRC7_reset(OPLL *) ;
//EMU2413_API void VRC7_set_rate(OPLL *opll, e_uint32 r) ;

/* Port/Register access */
EMU2413_API void VRC7_writeIO(OPLL *, e_uint32 reg, e_uint32 val) ;
EMU2413_API void VRC7_writeReg(OPLL *, e_uint32 reg, e_uint32 val) ;

/* Synthsize */
EMU2413_API e_int16 VRC7_calc(OPLL *) ;
/* or */
EMU2413_API void VRC7_run(OPLL *) ;
EMU2413_API e_uint32 VRC7_calcCh(OPLL *, e_uint32 ch) ;

/* Misc */
EMU2413_API void VRC7_forceRefresh(OPLL *) ;

/* Channel Mask */
EMU2413_API e_uint32 VRC7_setMask(OPLL *, e_uint32 mask) ;
EMU2413_API e_uint32 VRC7_toggleMask(OPLL *, e_uint32 mask) ;
